...
namespace NativeLibTestLegacy
{
    class Program
    {
        static int Main(string[] args)
        {
            Console.WriteLine("=== Secp256k1.Net Native Library Test (Legacy .NET Framework) ===");
            Console.WriteLine();
            Console.WriteLine("OS: " + Environment.OSVersion);
            Console.WriteLine("Architecture: " + (Environment.Is64BitProcess ? "x64" : "x86"));
            Console.WriteLine("Framework: " + RuntimeInformation.FrameworkDescription);
            Console.WriteLine("Runtime: " + (Type.GetType("Mono.Runtime") != null ? "Mono" : ".NET Framework"));
            Console.WriteLine();
