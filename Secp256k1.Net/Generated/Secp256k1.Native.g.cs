...
namespace Secp256k1Net
{
    ...
    /// <param name="ctx">pointer to a context object.</param>
    /// <param name="pubkey">pointer to a pubkey object. If 1 is returned, it is set to a parsed version of input. If not, its value is undefined.</param>
    ...
    /// <param name="ctx">pointer to a context object.</param>
    /// <param name="output">pointer to a 65-byte (if compressed==0) or 33-byte (if compressed==1) byte array to place the serialized key in.</param>
    /// <param name="outputlen">pointer to an integer which is initially set to the size of output, and is overwritten with the written size.</param>
    ...
    /// <param name="ctx">pointer to a context object</param>
    /// <param name="output">pointer to an array to store the DER serialization</param>
    ...
    /// <param name="sig">pointer to an array where the signature will be placed.</param>
    /// <param name="msghash32">the 32-byte message hash being signed.</param>
    ...
    /// <param name="ctx">pointer to a context object.</param>
    /// <param name="out">pointer to a public key object for placing the resulting public key.</param>
    ...
    /// <param name="ctx">pointer to a context object</param>
    /// <param name="hash32">pointer to a 32-byte array to store the resulting hash</param>
    /// <param name="tag">pointer to an array containing the tag</param>
    ...
    /// <param name="ctx">pointer to a context object.</param>
    /// <param name="output64">pointer to a 64-byte array of the compact signature.</param>
    ...
    /// <param name="ctx">pointer to a context object.</param>
    /// <param name="pubkey">pointer to the recovered public key.</param>
    ...
    /// <param name="ctx">pointer to a context object.</param>
    /// <param name="output">pointer to an array to be filled by hashfp.</param>
    /// <param name="pubkey">pointer to a secp256k1_pubkey containing an initialized public key.</param>
    ...
    /// <param name="ctx">pointer to a context object.</param>
    /// <param name="xonly_pubkey">pointer to an x-only public key object for placing the converted public key.</param>
    ...
    /// <param name="ctx">pointer to a context object.</param>
    /// <param name="output_pubkey">pointer to a public key to store the result. Will be set to an invalid value if this function returns 0.</param>
    ...
    /// <param name="ctx">pointer to a context object.</param>
    /// <param name="tweaked_pubkey32">pointer to a serialized xonly_pubkey.</param>
    /// <param name="tweaked_pk_parity">the parity of the tweaked pubkey (whose serialization is passed in as tweaked_pubkey32). This must match the pk_parity value that is returned when calling secp256k1_xonly_pubkey with the tweaked pubkey, or this function will fail.</param>
    ...
    /// <param name="ctx">pointer to a context object.</param>
    /// <param name="pubkey">pointer to an xonly_pubkey object, set to the keypair public key after converting it to an xonly_pubkey.</param>
    ...
    /// <param name="ctx">pointer to a context object (not secp256k1_context_static).</param>
    /// <param name="sig64">pointer to a 64-byte array to store the serialized signature.</param>
    ...
    /// <param name="ctx">pointer to a context object (not secp256k1_context_static).</param>
    /// <param name="sig64">pointer to a 64-byte array to store the serialized signature.</param>
    /// <param name="msg">the message being signed. Can only be NULL if msglen is 0.</param>
    ...
    /// <param name="ctx">pointer to a context object.</param>
    /// <param name="sig64">pointer to the 64-byte signature to verify.</param>
    ...
    /// <param name="ctx">pointer to a context object</param>
    /// <param name="ell64">pointer to a 64-byte array to be filled</param>
    /// <param name="pubkey">pointer to a secp256k1_pubkey containing an initialized public key</param>
    ...
    /// <param name="ctx">pointer to a context object (not secp256k1_context_static)</param>
    /// <param name="ell64">pointer to a 64-byte array to receive the ElligatorSwift public key</param>
    ...
    /// <param name="ctx">pointer to a context object.</param>
    /// <param name="output">pointer to an array to be filled by hashfp.</param>
    /// <param name="ell_a64">pointer to the 64-byte encoded public key of party A (will not be NULL)</param>
    /// <param name="ell_b64">pointer to the 64-byte encoded public key of party B (will not be NULL)</param>
    /// <param name="seckey32">pointer to our 32-byte secret key</param>
    /// <param name="party">boolean indicating which party we are: zero if we are party A, non-zero if we are party B. seckey32 must be the private key corresponding to that party&apos;s ell_?64. This correspondence is not checked.</param>
    ...
    /// <param name="ctx">pointer to a context object</param>
    /// <param name="agg_pk">the MuSig-aggregated x-only public key. If you do not need it, this arg can be NULL.</param>
    /// <param name="keyagg_cache">if non-NULL, pointer to a musig_keyagg_cache struct that is required for signing (or observing the signing session and verifying partial signatures).</param>
    ...
    /// <param name="ctx">pointer to a context object (not secp256k1_context_static)</param>
    /// <param name="secnonce">pointer to a structure to store the secret nonce</param>
    /// <param name="pubnonce">pointer to a structure to store the public nonce</param>
    /// <param name="session_secrand32">a 32-byte session_secrand32 as explained above. Must be unique to this call to secp256k1_musig_nonce_gen and must be uniformly random. If the function call is successful, the session_secrand32 buffer is invalidated to prevent reuse.</param>
    /// <param name="seckey">the 32-byte secret key that will later be used for signing, if already known (can be NULL)</param>
    /// <param name="pubkey">public key of the signer creating the nonce. The secnonce output of this function cannot be used to sign for any other public key. While the public key should correspond to the provided seckey, a mismatch will not cause the function to return 0.</param>
    /// <param name="msg32">the 32-byte message that will later be signed, if already known (can be NULL)</param>
    ...
    /// <param name="secnonce">pointer to a structure to store the secret nonce</param>
    /// <param name="pubnonce">pointer to a structure to store the public nonce</param>
    /// <param name="nonrepeating_cnt">the value of a counter as explained above. Must be unique to this call to secp256k1_musig_nonce_gen.</param>
    /// <param name="keypair">keypair of the signer creating the nonce. The secnonce output of this function cannot be used to sign for any other keypair.</param>
    /// <param name="msg32">the 32-byte message that will later be signed, if already known (can be NULL)</param>
    /// <param name="keyagg_cache">pointer to the keyagg_cache that was used to create the aggregate (and potentially tweaked) public key if already known (can be NULL)</param>
    /// <param name="extra_input32">an optional 32-byte array that is input to the nonce derivation function (can be NULL)</param>
    /// <returns>0 if the arguments are invalid and 1 otherwise</returns>
    ...
    /// <param name="ctx">pointer to a context object</param>
    /// <param name="aggnonce">pointer to an aggregate public nonce object for musig_nonce_process</param>
    ...
    /// <param name="ctx">pointer to a context object</param>
    /// <param name="session">pointer to a struct to store the session</param>
    /// <param name="aggnonce">pointer to an aggregate public nonce object that is the output of musig_nonce_agg</param>
    ...
    /// <param name="ctx">pointer to a context object</param>
    /// <param name="partial_sig">pointer to struct to store the partial signature</param>
    /// <param name="secnonce">pointer to the secnonce struct created in musig_nonce_gen that has been never used in a partial_sign call before and has been created for the keypair</param>
    /// <param name="keypair">pointer to keypair to sign the message with</param>
    ...
    /// <param name="ctx"></param>
    /// <param name="partial_sig">pointer to partial signature to verify, sent by the signer associated with `pubnonce` and `pubkey`</param>
    ...
    /// <param name="ctx">pointer to a context object</param>
    /// <param name="sig64">complete (but possibly invalid) Schnorr signature</param>
    /// <param name="session">pointer to the session that was created with musig_nonce_process</param>
